<script lang="ts">
	...
	async function handleLogin(e: Event) {
		...
		try {
			...
			await auth.login(data, rememberMe);
	...
	<div class="w-full max-w-md">
		...
		<div class="rounded-lg bg-white shadow-xl">
			<div class="border-b border-gray-200">
				<nav class="-mb-px flex">
					<button
						...
						class="w-1/2 border-b-2 px-4 py-3 text-center text-sm font-medium transition-colors {loginMethod ===
						'password'
			...
			<div class="space-y-6 p-6">
				...
				<p class="mt-4 text-center text-xs text-gray-500">Coming soon: Social login options</p>
			</div>
		</div>
		...
		<p class="mt-6 text-center text-sm text-gray-600">
			...
			<a href="/terms" class="font-medium text-orange-600 hover:text-orange-500">
				Terms of Service
			</a>
			and
			<a href="/privacy" class="font-medium text-orange-600 hover:text-orange-500">
				Privacy Policy</a
			>
		</p>
	</div>
