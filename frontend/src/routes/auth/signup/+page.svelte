			...
			<div class="bg-white rounded-lg shadow-xl p-6">
				...
				<form onsubmit={handleSignup} class="space-y-5">
					...
					<div>
						...
						<div class="mt-1">
							<input
								...
								class="appearance-none block w-full px-3 py-2 border rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 {nameError ? 'border-red-300' : 'border-gray-300'}"
					...
					<div>
						...
						<div class="mt-1">
							...
							{:else}
								<p class="mt-1 text-xs text-gray-500">Currently accepting gmail.com and example.com emails</p>
							{/if}
						</div>
					</div>
						...
						{#if password}
							<div class="mt-2">
								...
								<ul class="mt-2 text-xs text-gray-500 space-y-1">
									...
									<li class="{/[a-z]/.test(password) && /[A-Z]/.test(password) ? 'text-green-600' : ''}">✓ Mix of uppercase & lowercase</li>
									<li class="{/\d/.test(password) ? 'text-green-600' : ''}">✓ Include numbers</li>
									<li class="{/[!@#$%^&*(),.?":{}|<>]/.test(password) ? 'text-green-600' : ''}">✓ Include special characters</li>
								</ul>
							</div>
						{/if}
					</div>
					...
					<div class="flex items-start">
						...
						<div class="ml-3 text-sm">
							<label for="agree-terms" class="font-medium text-gray-700">
								I agree to the
								<a href="/terms" target="_blank" class="text-orange-600 hover:text-orange-500">Terms and Conditions</a>
								and
								<a href="/privacy" target="_blank" class="text-orange-600 hover:text-orange-500">Privacy Policy</a>
							</label>
						</div>
					</div>
				...
				<div class="mt-6">
					...
					<p class="text-xs text-center text-gray-500 mt-4">
						Coming soon: Social signup options
					</p>
				</div>
			</div>
		{:else}
			...
			<div class="bg-white rounded-lg shadow-xl p-8 text-center">
				...
				<h3 class="text-2xl font-bold text-gray-900 mb-2">Welcome to Rust Atlanta!</h3>
				<p class="text-gray-600 mb-6">
					We've sent a verification email to <strong class="text-gray-900">{email}</strong>
				</p>

				<div class="bg-orange-50 rounded-lg p-4 text-left mb-6">
				...
				<div class="space-y-3">
					...
					<button
						...
						disabled={isLoading}
						class="w-full py-2 px-4 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 disabled:opacity-50"
					>
