	...
	let events = $state<Event[]>([
		{
			...
			description:
				"Join us for a hands-on introduction to Rust programming. We'll cover basic syntax, ownership, borrowing, and build a small CLI application together.",
		...
		},
		{
			...
			description:
				"Deep dive into async programming in Rust. We'll explore tokio, async-std, and best practices for building concurrent applications.",
		...
		},
		{
			...
			description:
				'Learn how to compile Rust to WebAssembly and build high-performance web applications.',
		...
		},
		{
			...
			description:
				'Build a game in 48 hours using Rust and Bevy engine. Teams of up to 4 people, prizes for top 3 teams!',
		...
		},
		{
			...
			description:
				'Casual morning meetup to discuss Rust projects, share experiences, and network with fellow Rustaceans.',
		...
		},
		{
			...
			description:
				'Workshop on creating command-line interfaces with clap, structopt, and other popular Rust CLI libraries.',
		...
		},
		{
			...
			description:
				'Learn profiling techniques, optimization strategies, and how to write blazingly fast Rust code.',
		...
		<div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
			<div class="md:flex md:items-center md:justify-between">
				<div>
					...
					<p class="mt-2 text-gray-600">Join us for workshops, hackathons, and social gatherings</p>
				</div>
			...
			{:else}
				<div class="space-y-6">
					{#each filteredEvents as event}
						<div
							class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm transition-shadow hover:shadow-lg"
						>
							<div class="md:flex">
								<!-- Date Card -->
								<div
									class="bg-gradient-to-br from-orange-500 to-red-600 p-6 text-center text-white md:w-32"
								>
										...
										<div>
											...
											{#if event.speaker}
												<div class="mb-4 flex items-center gap-3">
													<div
														class="h-10 w-10 rounded-full bg-gradient-to-br from-orange-400 to-red-500"
													></div>
													<div>
											...
											{#if event.rsvpRequired}
												...
												<div class="flex gap-2">
													<button
														...
														class="rounded-lg px-4 py-2 font-medium transition-colors {rsvp?.status ===
														'attending'
			...
			<div class="rounded-lg bg-white p-6 shadow-lg">
				...
				<div class="grid grid-cols-7 gap-2">
					...
					{#each getCalendarDays() as day}
						<div
							class="min-h-24 rounded-lg border border-gray-200 p-2 {day
								? 'bg-white'
								: 'bg-gray-50'}"
						>
							{#if day}
								...
								{#if dayEvents.length > 0}
									<div class="space-y-1">
										{#each dayEvents.slice(0, 2) as event}
											<div
												class="cursor-pointer truncate rounded p-1 text-xs hover:opacity-80 {getEventTypeColor(
													event.type
												)}"
