<script lang="ts">
	...
	let articles = $state<Article[]>([
		{
			...
			excerpt:
				'Congratulations to all participants in our annual hackathon! Team Ferris took first place with their innovative WebAssembly-powered real-time collaboration tool.',
		...
		},
		{
			...
			excerpt:
				'Join our beginner-friendly study group as we work through the Rust Book together. Perfect for newcomers to the language!',
			content: 'Full article content here...',
			author: {
		...
		},
		{
			...
			excerpt:
				'Learn how to create a production-ready REST API using Actix Web, one of the fastest web frameworks in the Rust ecosystem.',
			content: 'Full article content here...',
			author: {
				name: 'Alex Chen',
		...
		},
		{
			...
			excerpt:
				'We sat down with Sarah Miller, a senior developer who successfully transitioned her team from Node.js to Rust, improving performance by 10x.',
			content: 'Full article content here...',
			author: {
				name: 'Interview Team',
		...
		},
		{
			...
			excerpt:
				'The latest Rust release brings exciting new features including improved async performance and enhanced const generics.',
			content: 'Full article content here...',
			author: {
				name: 'Tech News Team',
				role: 'Rust Atlanta'
		...
		},
		{
			...
			excerpt:
				'Highlighting amazing open-source Rust projects created by our local Atlanta community members.',
			content: 'Full article content here...',
			author: {
				name: 'Community Team',
				role: 'Rust Atlanta'
		...
		},
		{
			...
			excerpt:
				'Master error handling in Rust with this comprehensive guide covering Result, Option, and custom error types.',
			content: 'Full article content here...',
			author: {
		...
		},
		{
			...
			excerpt:
				"Missed our December meetup? Here's everything you need to know about async programming in Rust.",
			content: 'Full article content here...',
			author: {
				name: 'Events Team',
				role: 'Rust Atlanta'
	...
	let featuredArticles = $derived(articles.filter((article) => article.featured).slice(0, 2));
...
<div class="min-h-screen bg-gray-50">
			...
			<div class="grid gap-6 md:grid-cols-2">
				{#each featuredArticles as article}
					<a
						...
						class="group relative overflow-hidden rounded-lg bg-white shadow-lg transition-shadow hover:shadow-xl"
					>
						{#if article.imageUrl}
							<div class="aspect-video bg-gradient-to-br from-orange-400 to-red-500"></div>
						{:else}
							<div
								class="flex aspect-video items-center justify-center bg-gradient-to-br from-orange-400 to-red-500"
							>
						...
						<div class="p-6">
							...
							<h3
								class="mb-2 text-xl font-semibold text-gray-900 transition-colors group-hover:text-orange-600"
							>
								{article.title}
							</h3>
							...
							<div class="flex items-center justify-between text-sm text-gray-500">
								<div class="flex items-center gap-2">
									<div
										class="h-6 w-6 rounded-full bg-gradient-to-br from-orange-400 to-red-500"
									></div>
						...
						<div class="absolute top-4 right-4">
							<span
								class="inline-flex items-center rounded-full bg-yellow-400 px-2 py-1 text-xs font-bold text-gray-900"
							>
								⭐ FEATURED
							</span>
						</div>
			...
			<div class="flex flex-wrap gap-2">
				{#each categories as category}
					<button
						...
						class="inline-flex items-center gap-1 rounded-full px-3 py-1 text-sm font-medium transition-colors {selectedCategory ===
						category.value
							? 'bg-orange-600 text-white'
							: 'border border-gray-300 bg-white text-gray-700 hover:bg-gray-50'}"
					>
	...
	<div class="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
		...
		{:else}
			...
			<div class="mt-12 text-center">
				<button
					class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-6 py-3 font-medium text-gray-700 hover:bg-gray-50"
				>
					Load More Articles
	...
	<div class="bg-gradient-to-r from-orange-600 to-red-600 py-12">
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="text-center">
				<h2 class="mb-2 text-2xl font-bold text-white">Never Miss an Update</h2>
				<p class="mb-6 text-orange-100">
